...
//import org.apachae.commons.httpclient.HttpClient;
...
public class InformationProductionHelper extends WbdProductionHelper
{
	private String personId, userName, firstName, middleName, lastName, email;

	public InformationProductionHelper(Properties params)
	{
		super(params);
	}
