...
import tooltwist.training_nomer.productionHelpers.AddressProductionHelper;
 ...
 * Address Widget
 */
public class AddressWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "address_preview.html";
	private static final String SNIPPET_DESIGN = "address_design.html";
	private static final String SNIPPET_PRODUCTION = "address_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "address_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "address_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, AddressProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(AddressProductionHelper.class.getName()));
			}
		}
