...
import tooltwist.training_nomer.productionHelpers.PhoneListProductionHelper;
 ...
 * PhoneList Widget
 */
public class PhoneListWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "phoneList_preview.html";
	private static final String SNIPPET_DESIGN = "phoneList_design.html";
	private static final String SNIPPET_PRODUCTION = "phoneList_production.jsp";
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, PhoneListProductionHelper.class.getName(), productionHelperParams));
...
//		String myProperty = instance.getProperty("myProperty", null);
		String informationPage = instance.getProperty("targetPage", null); //ttDemo-17
		String titlePage = instance.getProperty("titlePage", null);
		informationPage =RoutingUIM.navpointUrl(ud, informationPage, AutomaticUrlParametersMode.NO_AUTOMATIC_URL_PARAMETERS); //ttsvr/n/ttDemo-17
		SnippetParam[] params = {
