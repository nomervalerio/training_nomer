...
import tooltwist.training_nomer.productionHelpers.InformationWidgetProductionHelper;
 ...
 * Information Widget
 */
public class InformationWidgetWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "informationWidget_preview.html";
	private static final String SNIPPET_DESIGN = "informationWidget_design.html";
	private static final String SNIPPET_PRODUCTION = "informationWidget_production.jsp";
...
//		instance.defineProperty(new WbdStringProperty("myProperty", null, "My Property", ""));
		instance.defineProperty(new WbdNavPointProperty("addressPage", null, "Address Page", ""));
		instance.defineProperty(new WbdNavPointProperty("phonePage", null, "Phone Page", ""));
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "informationWidget_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "informationWidget_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, InformationWidgetProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(InformationWidgetProductionHelper.class.getName()));
			}
		}
