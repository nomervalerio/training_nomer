...
//import tooltwist.training_nomer.productionHelpers.PhoneFilterProductionHelper;
import com.dinaa.ui.UimData;
import com.dinaa.ui.UimHelper;

/**
 * Filter Widget for Phone
 */
public class PhoneFilterWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "phoneFilter_preview.html";
	private static final String SNIPPET_DESIGN = "phoneFilter_design.html";
	private static final String SNIPPET_PRODUCTION = "phoneFilter_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "phoneFilter_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "phoneFilter_jsHeader.js"),

//				// Include a CSS snippet
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "phoneFilter_cssHeader.css")),
			};
			codeInserterList.add(arr);
		}
...
//				codeInserterList.add(WbdProductionHelper.codeInserter(instance, PhoneFilterProductionHelper.class.getName(), productionHelperParams));
//				codeInserterList.add(new PageImportCodeInserter(PhoneFilterProductionHelper.class.getName()));
			}
		}
