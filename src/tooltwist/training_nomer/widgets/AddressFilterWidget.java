...
//import tooltwist.training_nomer.productionHelpers.AddressFilterProductionHelper;
import com.dinaa.ui.UimData;
import com.dinaa.ui.UimHelper;

/**
 * Filter Widget for Address
 */
public class AddressFilterWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "addressFilter_preview.html";
	private static final String SNIPPET_DESIGN = "addressFilter_design.html";
	private static final String SNIPPET_PRODUCTION = "addressFilter_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "addressFilter_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "addressFilter_jsHeader.js"),

//				// Include a CSS snippet
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "addressFilter_cssHeader.css")),
			};
			codeInserterList.add(arr);
		}
...
//				codeInserterList.add(WbdProductionHelper.codeInserter(instance, AddressFilterProductionHelper.class.getName(), productionHelperParams));
//				codeInserterList.add(new PageImportCodeInserter(AddressFilterProductionHelper.class.getName()));
			}
		}
