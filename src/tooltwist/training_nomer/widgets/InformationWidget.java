...
import tooltwist.training_nomer.productionHelpers.InformationProductionHelper;
 ...
 * Information Widget
 */
public class InformationWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "information_preview.html";
	private static final String SNIPPET_DESIGN = "information_design.html";
	private static final String SNIPPET_PRODUCTION = "information_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "information_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "information_jsHeader.js"),

//				// Include a CSS snippet
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "informationWidget_cssHeader.css")),
			};
			codeInserterList.add(arr);
		}
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, InformationProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(InformationProductionHelper.class.getName()));
			}
		}
