...
import tooltwist.training_nomer.productionHelpers.RegistrationProductionHelper;
 ...
 * Registration Widget
 */
public class RegistrationWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "registration_preview.html";
	private static final String SNIPPET_DESIGN = "registration_design.html";
	private static final String SNIPPET_PRODUCTION = "registration_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "registration_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "registration_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, RegistrationProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(RegistrationProductionHelper.class.getName()));
			}
		}
...
//		String myProperty = instance.getProperty("myProperty", null);
		String listPage = instance.getProperty("backPage", null); //ttDemo-14
		listPage =RoutingUIM.navpointUrl(ud, listPage, AutomaticUrlParametersMode.NO_AUTOMATIC_URL_PARAMETERS); //ttsvr/n/ttDemo-14
		SnippetParam[] params = {
//			new SnippetParam("myProperty", myProperty),
			new SnippetParam("listPage", listPage)
		};
		return params;
	}
}
